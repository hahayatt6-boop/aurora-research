---
id: EVD-035
title: "中国家长 WTP 定价实验（pending scaffold）"
...
tags: [wtp, china, pricing, psm, pending, primary-research]
---

# 来源

Pending Aurora primary research scaffold for [RES-003-WTP](../research/RES-003-WTP-pricing-experiment.md).

**当前状态：pending。** 本记录尚未包含真实问卷结果、真实 OPP/PMC/PME、购买确定性比例或需求量折减结果。不得将本记录引用为 ARV-005 条件 2 已满足的证据。

## 背景

计划执行一项中国 4-8 岁儿童家长 WTP 定价实验：
...
当前无真实来源结果。以下字段必须在实际聚合数据产生后填写：

| 字段 | 当前状态 |
| --- | --- |
| 总完成样本 | pending |
| 主分析有效样本 | pending |
| 19 元/月高确定性样本占比 | pending |
| 39 元/月高确定性样本占比 | pending |
| 69 元/月高确定性样本占比 | pending |
| stated preference OPP/PMC/PME | pending |
| high certainty OPP/PMC/PME | pending |
| conservative demand index | pending |
| top trust requirements | pending |
| value driver ranking | pending |

## 研究者解释

当前解释仅限于方法准备：

- 本 scaffold 说明 EVD-035 未来应如何记录结果，不提供任何已发生的 WTP 结论。
...
当前可靠性为 `low`，因为真实问卷尚未发放或尚未产生可验证聚合结果。本记录只能作为待填结果框架，不能单独支持任何重大决策。

可靠性最多可在以下条件满足后提升至 `medium`：
...
只有在真实聚合数据完成后，才允许把本记录从 pending scaffold 更新为结果证据。更新时必须：
